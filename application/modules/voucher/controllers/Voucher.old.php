...
class Voucher extends MY_Controller {
	...
	public function pdf()
	{
		...
		$pdf->Image('http://'.$_SERVER['SERVER_NAME'].'/assets/img/logosra2.png',3,2,43,23,'png');
		...
		$pdf->Image("http://".$_SERVER['SERVER_NAME']."/assets/img/qrcarteskdo/".$qrpath,8.5,50,30,30,'png');
		$pdf->SetFillColor(227,5,19);
		$pdf->Rect(47,0,3,90,'F');
		...
		$pdf->SetY(82);
		$pdf->SetX(4);
		$pdf->Cell(39,3,utf8_decode("Carte ".$infosvoucher->code),0,0,'C');
		...
		$pdf->Cell(15,4,'Pour :',0);
		$pdf->SetFont('Gloss','',18);
		$pdf->Cell(92,4,$destaffiche,0);
		$pdf->SetFont('Helvetica','',8);
		$pdf->Cell(20,4,utf8_decode("Valable jusqu'à"),0,0,'C');
		$pdf->Ln(8);
		$pdf->SetX(55);
		$pdf->SetFont('Helvetica','',8);
		$pdf->Cell(15,4,'Offerte par :',0);
		$pdf->SetFont('Gloss','',13);
