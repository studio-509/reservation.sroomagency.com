    	...
    	<div id="header-wrapper" class="wrapper bgcolor01">
            <header id="header" class="container">
                <div class="col-xs-12 col-sm-4 mb8 mt8">
                	<a id="logo" href="/user/reservations"><?php echo APP_NAME; ?></a>
                </div>
				<div class="text-center mb8 mt8 col-sm-1"><span id="ejs_heure"></span></div>
				<div class="col-xs-12 col-sm-3 mt8 pull-right">
                    <div id="log_header">
                    	<div class="user_name pull-left">Bienvenue <strong><?php echo $userfirstname ?></strong></div>
                        <div class="pull-right"><a href="/user/logout">déconnexion</a></div>
                    </div>
                     <div id="notification">
                     </div>
