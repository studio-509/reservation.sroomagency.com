...
$this->nonPrintMargin = 0;		// Non-printable border at edge of paper sheet in mm
$this->defaultPagebreakType = 'slice';	// 'slice' or 'cloneall' or 'clonebycss' - for forced pagebreaks using <pagebreak />
